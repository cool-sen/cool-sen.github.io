...
在项目根目录下直接使用 `hugo` 命令，会生成 public 目录，该目录下都是关于我们的 markdown 编译完成的 html 静态页面。博客安装好之后，就该进行部署了，可以部署到自己的网站，也可以部署到Git Page。我使用的是Git Page，可以参考我的另一篇文章[Hugo+Github Pages搭建博客](https://cool-sen.github.io/posts/hugo搭建博客二/)
